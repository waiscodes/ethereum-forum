...
>((props, ref) => (
  <div className="raycast-cmdk-input flex items-center border-b border-primary px-4 py-2 bg-secondary" cmdk-input-wrapper="">
...
>((props, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className="-mx-2 my-2 h-px bg-secondary"
    {...props}
  />
))
